...
namespace
{
QString getSynchronizeLeadNameStatic4(Lead lead, u32 flags, u8 targetNature)
{
...
QString getLeadNameStatic4(Lead lead, Lead synchronizeLead, u32 synchronizeFlags, u8 flags, u8 targetNature)
{
    if (lead == Lead::None)
    {
