...
private:
    QStringList header
        = { tr("Seed"), tr("Pass Power"), tr("Advances"), tr("Group"), tr("Slot"), tr("Amount"), tr("Date/Time"), tr("Timer0"), tr("Buttons") };
    bool showPassPower;
};
...
public:
    /**
     * @brief Construct a new HiddenGrottoGeneratorModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    HiddenGrottoGeneratorModel5(QObject *parent);
...
public:
    /**
     * @brief Construct a new HiddenGrottoSearcherModel5 object
     *
     * @param parent Parent object, which takes memory ownership
     */
    HiddenGrottoSearcherModel5(QObject *parent);
...
private:
    QStringList header = { tr("Seed"),      tr("Advances"), tr("IV Advances"), tr("Level"), tr("PID"),    tr("Shiny"),
                           tr("Nature"),    tr("Ability"),  tr("HP"),          tr("Atk"),   tr("Def"),    tr("SpA"),
                           tr("SpD"),       tr("Spe"),      tr("Hidden"),      tr("Power"), tr("Gender"), tr("Characteristic"),
