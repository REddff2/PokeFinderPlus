...
namespace
{
QString getSynchronizeLeadName3(Lead lead, u32 flags, u8 targetNature)
{
...
QString getLeadName3(Lead lead, Lead synchronizeLead, u32 synchronizeFlags, u8 flags, u8 targetNature)
{
    if (lead == Lead::None)
    {
