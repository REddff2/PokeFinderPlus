...
#ifndef MILESTONE2WILDGENERATOR5_HPP
#define MILESTONE2WILDGENERATOR5_HPP
...
namespace Milestone2PassPower5
{
    constexpr u8 None = 0;
...
class Milestone2WildGenerator5 : public WildGenerator<EncounterArea5, Profile5, WildStateFilter>
{
public:
    /**
     * @brief Construct a new Milestone2WildGenerator5 object
     *
     ...
     */
    Milestone2WildGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, Lead lead, u8 passPower, bool searchMovingTrigger,
                   bool requireMovingTrigger, const EncounterArea5 &area, const Profile5 &profile, const WildStateFilter &filter);

    Milestone2WildGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, Lead lead, const std::vector<u8> &passPowers,
     ...
     * @param filter State filter
     */
    Milestone2WildGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, const std::vector<Lead> &leads, u8 luckyPower,
                   const EncounterArea5 &area, const Profile5 &profile, const WildStateFilter &filter);

    Milestone2WildGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, const std::vector<Lead> &leads,
                   ...
                   bool filterNonRequiredLeads = true, bool optimizedPruning = true);
...
#endif // MILESTONE2WILDGENERATOR5_HPP
