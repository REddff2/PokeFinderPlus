...
#include "CoverageBaselineIVCacheSearcher.hpp"
...
CoverageBaselineIVCacheSearcher::CoverageBaselineIVCacheSearcher(u32 initialAdvances, u32 maxAdvances) :
...
void CoverageBaselineIVCacheSearcher::startSearch(int threads)
{
...
void CoverageBaselineIVCacheSearcher::writeResults(std::string_view file)
{
...
void CoverageBaselineIVCacheSearcher::search(u32 start, u32 end)
{
    while (true)
    {
