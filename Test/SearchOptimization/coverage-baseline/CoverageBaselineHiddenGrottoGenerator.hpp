...
#ifndef COVERAGE_BASELINE_HIDDENGROTTOGENERATOR_HPP
#define COVERAGE_BASELINE_HIDDENGROTTOGENERATOR_HPP
 ...
 */
class CoverageBaselineHiddenGrottoSlotGenerator : public Generator<Profile5, HiddenGrottoFilter>
{
public:
    /**
     * @brief Construct a new CoverageBaselineHiddenGrottoSlotGenerator object
     *
     ...
     */
    CoverageBaselineHiddenGrottoSlotGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, PassPower grottoPower,
                              const HiddenGrottoArea &encounterArea, const Profile5 &profile, const HiddenGrottoFilter &filter,
                              u16 item = 0, u8 minItemAmount = 1);

    CoverageBaselineHiddenGrottoSlotGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, const std::vector<PassPower> &grottoPowers,
                              const HiddenGrottoArea &encounterArea, const Profile5 &profile, const HiddenGrottoFilter &filter,
                              u16 item = 0, u8 minItemAmount = 1);
 ...
 */
class CoverageBaselineHiddenGrottoGenerator : public Generator<Profile5, StateFilter>
{
public:
    /**
     * @brief Construct a new CoverageBaselineHiddenGrottoGenerator object
     *
     * @param initialAdvances Initial number of advances
     * @param maxAdvances Maximum number of advances
     * @param offset Number of advances to offset
     ...
     * @param filter State filter
     */
    CoverageBaselineHiddenGrottoGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, Lead lead, u8 gender, const HiddenGrottoSlot &slot,
