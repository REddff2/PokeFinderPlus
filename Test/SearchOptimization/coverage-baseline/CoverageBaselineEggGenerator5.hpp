...
#ifndef COVERAGE_BASELINE_EGGGENERATOR5_HPP
#define COVERAGE_BASELINE_EGGGENERATOR5_HPP
 ...
 */
class CoverageBaselineEggGenerator5 : public EggGenerator<Profile5, StateFilter>
{
public:
    /**
     * @brief Construct a new CoverageBaselineEggGenerator5 object
     *
     ...
     */
    CoverageBaselineEggGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, const Daycare &daycare, const Profile5 &profile,
