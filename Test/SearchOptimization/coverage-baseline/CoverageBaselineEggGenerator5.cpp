...
#include "CoverageBaselineEggGenerator5.hpp"
...
CoverageBaselineEggGenerator5::CoverageBaselineEggGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, const Daycare &daycare, const Profile5 &profile,
...
std::vector<EggState5> CoverageBaselineEggGenerator5::generate(u64 seed) const
{
...
std::vector<EggState5> CoverageBaselineEggGenerator5::generateBW(u64 seed) const
{
...
std::vector<EggState5> CoverageBaselineEggGenerator5::generateBW2(u64 seed) const
{
    std::vector<EggState5> states;
...
EggState5 CoverageBaselineEggGenerator5::generateBW2Egg(u64 seed, const PersonalInfo **info) const
{
    BWRNG rng(seed);
