...
#ifndef COVERAGE_BASELINE_SHA1CACHESEARCHER_HPP
#define COVERAGE_BASELINE_SHA1CACHESEARCHER_HPP
 ...
 */
class CoverageBaselineSHA1CacheSearcher final : public SearcherBase<SHA1Seed>
{
public:
    /**
     * @brief Construct a new CoverageBaselineSHA1CacheSearcher object
     *
     ...
     * @param end End date
     */
    CoverageBaselineSHA1CacheSearcher(const IVCache &ivCache, const Profile5 &profile, const Date &start, const Date &end);
