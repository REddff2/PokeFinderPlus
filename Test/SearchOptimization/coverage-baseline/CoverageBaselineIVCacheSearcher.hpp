...
#ifndef COVERAGE_BASELINE_IVCACHESEARCHER_HPP
#define COVERAGE_BASELINE_IVCACHESEARCHER_HPP
 ...
 */
class CoverageBaselineIVCacheSearcher final : public SearcherBase<std::vector<u32>>
{
public:
    /**
     * @brief Construct a new CoverageBaselineIVCacheSearcher object
     *
     * @param initialAdvances
     * @param maxAdvances Maximum number of advances
     */
    CoverageBaselineIVCacheSearcher(u32 initialAdvances, u32 maxAdvances);
    ...
    // Verification-only bounded entry point. Frozen seed/RNG loop is unchanged.
    void runRange(u32 first, u32 last) { index.store(first); search(0, last); }
