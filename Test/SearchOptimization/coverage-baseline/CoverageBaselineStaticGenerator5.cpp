...
#include "CoverageBaselineStaticGenerator5.hpp"
...
CoverageBaselineStaticGenerator5::CoverageBaselineStaticGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, Lead lead, u8 luckyPower,
                                   const StaticTemplate5 &staticTemplate, const Profile5 &profile, const StateFilter &filter) :
    CoverageBaselineStaticGenerator5(initialAdvances, maxAdvances, offset, method, lead, std::vector<u8> { luckyPower }, staticTemplate, profile, filter)
{
}

CoverageBaselineStaticGenerator5::CoverageBaselineStaticGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, Lead lead, const std::vector<u8> &luckyPowers,
                                   const StaticTemplate5 &staticTemplate, const Profile5 &profile, const StateFilter &filter) :
    CoverageBaselineStaticGenerator5(initialAdvances, maxAdvances, offset, method, std::vector<Lead> { lead }, luckyPowers, staticTemplate, profile, filter)
{
}

CoverageBaselineStaticGenerator5::CoverageBaselineStaticGenerator5(u32 initialAdvances, u32 maxAdvances, u32 offset, Method method, const std::vector<Lead> &leads,
                                   u8 luckyPower, const StaticTemplate5 &staticTemplate, const Profile5 &profile,
                                   const StateFilter &filter) :
    CoverageBaselineStaticGenerator5(initialAdvances, maxAdvances, offset, method, leads, std::vector<u8> { luckyPower }, staticTemplate, profile, filter)
{
}
...
std::vector<State5> CoverageBaselineStaticGenerator5::generate(u64 seed, u32 initialAdvances, u32 maxAdvances) const
{
...
std::vector<State5> CoverageBaselineStaticGenerator5::generate(u64 seed, const std::vector<std::pair<u32, std::array<u8, 6>>> &ivs) const
{
...
std::vector<State5> CoverageBaselineStaticGenerator5::generateNonWild(u64 seed, const std::vector<std::pair<u32, std::array<u8, 6>>> &ivs) const
{
...
std::vector<State5> CoverageBaselineStaticGenerator5::generateWild(u64 seed, const std::vector<std::pair<u32, std::array<u8, 6>>> &ivs) const
{
    std::vector<State5> states;
...
std::vector<State5> CoverageBaselineStaticGenerator5::generateWild(u64 seed, const std::vector<std::pair<u32, std::array<u8, 6>>> &ivs, u8 luckyPower,
                                                   Lead lead) const
{
    u32 advances = Utilities5::initialAdvances(seed, profile);
    BWRNG rng(seed, advances + initialAdvances);
