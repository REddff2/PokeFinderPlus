...
#ifndef COVERAGE_BASELINE_ADJACENTSEEDSCALCULATOR_HPP
#define COVERAGE_BASELINE_ADJACENTSEEDSCALCULATOR_HPP
...
namespace CoverageBaselineAdjacentSeedsCalculator
{
    /**
