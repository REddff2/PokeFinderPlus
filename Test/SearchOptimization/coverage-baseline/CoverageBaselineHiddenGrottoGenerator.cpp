...
#include "CoverageBaselineHiddenGrottoGenerator.hpp"
...
CoverageBaselineHiddenGrottoSlotGenerator::CoverageBaselineHiddenGrottoSlotGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, PassPower grottoPower,
                                                     const HiddenGrottoArea &encounterArea, const Profile5 &profile,
                                                     const HiddenGrottoFilter &filter, u16 item, u8 minItemAmount) :
    CoverageBaselineHiddenGrottoSlotGenerator(initialAdvances, maxAdvances, offset, std::vector<PassPower> { grottoPower }, encounterArea, profile, filter,
                              item, minItemAmount)
{
}

CoverageBaselineHiddenGrottoSlotGenerator::CoverageBaselineHiddenGrottoSlotGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset,
...
std::vector<HiddenGrottoState> CoverageBaselineHiddenGrottoSlotGenerator::generate(u64 seed) const
{
...
std::vector<HiddenGrottoState> CoverageBaselineHiddenGrottoSlotGenerator::generate(u64 seed, PassPower grottoPower) const
{
...
CoverageBaselineHiddenGrottoGenerator::CoverageBaselineHiddenGrottoGenerator(u32 initialAdvances, u32 maxAdvances, u32 offset, Lead lead, u8 gender,
...
std::vector<State5> CoverageBaselineHiddenGrottoGenerator::generate(u64 seed, u32 initialAdvances, u32 maxAdvances) const
{
...
std::vector<State5> CoverageBaselineHiddenGrottoGenerator::generate(u64 seed, const std::vector<std::pair<u32, std::array<u8, 6>>> &ivs) const
{
