...
#ifndef COVERAGE_BASELINE_PICKUPGENERATOR_HPP
#define COVERAGE_BASELINE_PICKUPGENERATOR_HPP
...
class CoverageBaselinePickupGenerator
{
public:
    struct Slot
    {
    ...
    CoverageBaselinePickupGenerator(u32 initialAdvances, u32 maxAdvances, const std::array<Slot, 6> &pickupSlots, const std::vector<Request> &requests,
                    const EncounterArea5 &area, const Profile5 &profile, bool includeInvalid = false);
    CoverageBaselinePickupGenerator(u32 initialAdvances, u32 maxAdvances, const std::array<Slot, 6> &pickupSlots, const EncounterArea5 &area,
