...
{
    const QModelIndex original = ModelIndexMapping::sourceRow(ui->tableView->currentIndex());
    const QModelIndex sourceIndex = ModelIndexMapping::fromSource(original, sourceTableView->model());
