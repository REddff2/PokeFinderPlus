...
public:
    ...
    /**
     * @brief Gets only explicitly checked action data
     *
     * @return Explicitly checked action data
     */
    std::vector<int> getRawCheckedData() const;
...
signals:
    /**
     * @brief Emitted when checked actions change in multi-select mode
     */
    void checkedDataChanged();
