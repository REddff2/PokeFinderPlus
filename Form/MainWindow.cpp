...
MainWindow::MainWindow(bool profile, QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    ui->menubar->addMenu(pluginManager->menu());
    setWindowTitle(QString("PokeFinder+ %1").arg(POKEFINDER_VERSION));
    ...
    connect(ui->pushButtonPhenomenon, &QPushButton::clicked, this, &MainWindow::openPhenomenon);
